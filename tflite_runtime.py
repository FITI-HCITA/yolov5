...
if __name__ == '__main__':
    ...
    os.makedirs(os.path.dirname(os.path.abspath(__file__)) + '/data/datasets/inference', exist_ok=True)       
    cv2.imwrite(os.path.dirname(os.path.abspath(__file__)) + '/data/datasets/inference/result.jpg', result_img)

    print("prediction saved at: ", os.path.dirname(os.path.abspath(__file__)) + '/data/datasets/inference/result.jpg')
