...
```bash
python3 ai_pipeline.py --data data/training_cfg/data_config.yaml --weights Hand_Gestures_3_001_001.pt --batch-size 1 --imgch 3 --imgsz 320 --device 0 --include tflite --int8 --run export
